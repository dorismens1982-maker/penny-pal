          ...
          <body>
            <div class="container">
              <div class="card">
                ...
                <h1 class="heading">Welcome to the inner circle, ${userName}!</h1>
                <p class="text">We're so excited to have you join us. Penny Pal is built to help you master your money and build real wealth. Your journey starts today.</p>
                
                <a href="https://www.mypennypal.com/dashboard" class="button">Go to your Dashboard</a>
