  ...
  return (
    <Layout>
      <div className="min-h-screen bg-background">
        ...
        <div
          className={`sticky md:fixed top-0 md:top-[60px] left-0 w-full z-[60] backdrop-blur-lg border-b border-border transition-all duration-300 ${
        ...
        {/* Spacer for fixed category bar only on md+ */}
        <div className="hidden md:block md:h-[64px]" />

        {/* Hero Banner (removed manual md:mt) */}
