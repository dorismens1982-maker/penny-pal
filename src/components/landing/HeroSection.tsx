    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="container px-4 md:px-6 flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left gap-12 lg:gap-16 pt-10 lg:pt-20 animate-fade-in-up">
                ...
                {/* Right Column - Media */}
                <div className="flex-1 w-full lg:max-w-2xl perspective-1000">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20 transform rotate-x-6 lg:rotate-y-0 hover:rotate-x-0 transition-transform duration-700 ease-out group">
                        {videoSrc ? (
